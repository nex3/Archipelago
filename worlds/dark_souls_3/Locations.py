...
location_tables: Dict[str, List[DS3LocationData]] = {
    ...
    "Road of Sacrifices": [
        ...
        DS3LocationData("FS: Farron Dart - Orbeck", "Farron Dart",
                        static='99,0:-1:110000,130100,70000111:', missable=missable_shop, npc=True,
                        shop=True),
        DS3LocationData("FS: Soul Arrow - Orbeck", "Soul Arrow",
                        static='99,0:-1:110000,130100,70000111:', missable=missable_shop, npc=True,
                        shop=True),
        DS3LocationData("FS: Great Soul Arrow - Orbeck", "Great Soul Arrow", missable=missable_shop,
                        npc=True, shop=True),
        ...
        DS3LocationData("FS: Magic Shield - Orbeck", "Magic Shield",
                        static='99,0:-1:110000,130100,70000111:', missable=missable_shop, npc=True,
                        shop=True),
        DS3LocationData("FS: Spook - Orbeck", "Spook", missable=missable_shop, npc=True, shop=True),
        DS3LocationData("FS: Aural Decoy - Orbeck", "Aural Decoy", missable=missable_shop, npc=True,
                        shop=True),
        ...
        DS3LocationData("FS: Homing Crystal Soulmass - Orbeck for Crystal Scroll",
                        "Homing Crystal Soulmass", missable=missable_shop, npc=True, shop=True),
        ...
        DS3LocationData("FS: Crystal Magic Weapon - Orbeck for Crystal Scroll",
                        "Crystal Magic Weapon", missable=missable_shop, npc=True, shop=True),
        ...
        DS3LocationData("FS: Twisted Wall of Light - Orbeck for Golden Scroll",
                        "Twisted Wall of Light", missable=missable_shop, npc=True, shop=True),
        ...
        DS3LocationData("FS: Hidden Body - Orbeck for Golden Scroll", "Hidden Body",
                        missable=missable_shop, npc=True, shop=True),
        DS3LocationData("FS: Repair - Orbeck for Golden Scroll", "Repair", missable=missable_shop,
                        npc=True, shop=True),
        DS3LocationData("FS: Clandestine Coat - shop with Orbeck's Ashes", "Clandestine Coat",
                        missable=missable_shop, npc=True,
        ...
        DS3LocationData("FS: Young Dragon Ring - Orbeck for one scroll and buying three spells",
                        "Young Dragon Ring", missable=missable_shop, npc=True),
        DS3LocationData("FS: Slumbering Dragoncrest Ring - Orbeck for buying four specific spells",
                        "Slumbering Dragoncrest Ring", missable=missable_shop, npc=True),
